package com.example.android.egafirmansyah_1202150031_studycase4;
...
public class ListMahasiswa extends AppCompatActivity {
    ...
    */
    public String[] listNama(){
        return new String[]{
                "Hayabusa","Hanaby","Karrie","Lasley","Alucard","Lancelot","Layla","Alpha","Saber","Gussion","Bane","Balmoon","Fanny","Tigreal","Hilda","Zilong","Nana","Iritel","Kagura","Eduora"
        };
    }
